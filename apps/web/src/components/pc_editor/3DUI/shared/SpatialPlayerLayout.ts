...
export const spatialPlayerSkinRects = {
  ...
  effectSpeedPanel: { height: 74, left: 1450, top: 145, width: 180 },
  nextButton: { height: 58, left: 200, top: 153, width: 58 },
  playbackRatePanel: { height: 74, left: 1070, top: 145, width: 180 },
  ...
  recordPanel: { height: 74, left: 880, top: 145, width: 180 },
  recordingRatePanel: { height: 74, left: 1260, top: 145, width: 180 },
  settingsButton: { height: 58, left: 1688, top: 153, width: 58 },
  titlePanel: { height: 74, left: 296, top: 145, width: 560 },
...
export const spatialPlayerTextSlots = {
  ...
  effectSpeedKey: { maxChars: 16, scale: "0.12 0.12 0.12", width: 1.8, x: centerX(spatialPlayerSkinRects.effectSpeedPanel), y: spatialPlayerSkinRects.effectSpeedPanel.top + 54 },
  effectSpeedLabel: { maxChars: 9, scale: "0.18 0.18 0.18", width: 1.8, x: centerX(spatialPlayerSkinRects.effectSpeedPanel), y: spatialPlayerSkinRects.effectSpeedPanel.top + 29 },
  ...
  playbackRateKey: { maxChars: 16, scale: "0.12 0.12 0.12", width: 1.85, x: centerX(spatialPlayerSkinRects.playbackRatePanel), y: spatialPlayerSkinRects.playbackRatePanel.top + 54 },
  playbackRateLabel: { maxChars: 11, scale: "0.18 0.18 0.18", width: 1.85, x: centerX(spatialPlayerSkinRects.playbackRatePanel), y: spatialPlayerSkinRects.playbackRatePanel.top + 29 },
  ...
  recordKey: { maxChars: 8, scale: "0.13 0.13 0.13", width: 1.95, x: centerX(spatialPlayerSkinRects.recordPanel), y: spatialPlayerSkinRects.recordPanel.top + 54 },
  recordLabel: { maxChars: 12, scale: "0.2 0.2 0.2", width: 1.95, x: centerX(spatialPlayerSkinRects.recordPanel), y: spatialPlayerSkinRects.recordPanel.top + 29 },
  recordingRateKey: { maxChars: 16, scale: "0.12 0.12 0.12", width: 1.85, x: centerX(spatialPlayerSkinRects.recordingRatePanel), y: spatialPlayerSkinRects.recordingRatePanel.top + 54 },
  recordingRateLabel: { maxChars: 12, scale: "0.18 0.18 0.18", width: 1.85, x: centerX(spatialPlayerSkinRects.recordingRatePanel), y: spatialPlayerSkinRects.recordingRatePanel.top + 29 },
  ...
  subtitle: { align: "left", maxChars: 58, scale: "0.112 0.112 0.112", width: 3.5, x: subtitlePoint.x, y: subtitlePoint.y },
  title: { align: "left", maxChars: 46, scale: "0.132 0.132 0.132", width: 3.5, x: titlePoint.x, y: titlePoint.y }
