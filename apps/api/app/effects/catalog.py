...
EFFECTS = [
    ...
    effect(
        category_id="overlay",
        duration_ms=1800,
        effect_id="portal-ring",
        event_name="overlay.portal_ring",
        family="overlay",
        key="3",
        label="Portal ring",
        params={
    ...
    effect(
        category_id="overlay",
        duration_ms=2200,
        effect_id="time-vortex",
        event_name="overlay.time_vortex",
        family="overlay",
        key="4",
        label="Time vortex",
        params={
    ...
    effect(
        category_id="overlay",
        duration_ms=900,
        effect_id="explosion-sticker",
        event_name="overlay.explosion_sticker",
        family="overlay",
        key="5",
